...
import com.ehsaniara.multidatasource.utils.enums.WebBrowser;
...
public class RandomUserAgent {
    ...
    public static Map<WebBrowser, String[]> userAgentMap(){
        Map<WebBrowser, String[]> userAgentMap = new HashMap<>();
        userAgentMap.put(WebBrowser.INTERNET_EXPLORER, new String[] {
        ...
        userAgentMap.put(WebBrowser.FIREFOX, new String[] {
        ...
        userAgentMap.put(WebBrowser.CHROME, new String[] {
        ...
        userAgentMap.put(WebBrowser.SAFARI, new String[] {
        ...
        userAgentMap.put(WebBrowser.OPERA, new String[] {
    ...
    public static String getRandomUserAgent(WebBrowser webBrowserToUse, Map<WebBrowser, String[]> userAgentMapVariable) {
        String userAgents[] = userAgentMapVariable.get(webBrowserToUse);
        if(userAgents.length == 0){
            userAgents = userAgentMapVariable.get(WebBrowser.values()[(int) Math.floor(Math.random()*(WebBrowser.values().length - 1))]);
        }
        return userAgents[(int) Math.floor(Math.random() * userAgents.length)];
    }

    public static WebBrowser getWebBrowserToUse(Map<WebBrowser, Double> fequencyMap){
        double rand = Math.random() * 100;
        WebBrowser browser = null;
        double count = 0.0;
        for(Entry<WebBrowser, Double> freq : fequencyMap.entrySet()) {
            count += freq.getValue();
            if(rand <= count) {
                browser = freq.getKey();
                break;
